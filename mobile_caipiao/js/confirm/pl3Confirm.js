  var pl3ConfirmObj = new BetConfirm({
	   'name': 'pl3Confirm',
	   'tpl' : 'template/confirm/betlist.html'
  });
  pl3ConfirmObj.setDefConfig = function(){
  ...
  pl3ConfirmObj.setLotteryPlayData = function(){
  ...
  pl3ConfirmObj.destroy = function(){
	this.setDefConfig();
	$('#pl3Confirm').html('').remove();
	window.localStorage.removeItem('pl3lotteryBetData');
	window.localStorage.removeItem('pl3lotteryAllBetData');
	window.localStorage.removeItem('pl3MulAndPer'); 
  }
