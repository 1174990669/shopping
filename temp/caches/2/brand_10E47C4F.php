...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> 卓诗尼</div>
</div>
<div class="blank"></div>
  <div class="w main">
    <div class="right-extra">
      <div class="box">
        <h3 class="goods_sxtitle"><span>卓诗尼</span></h3>
        <div class="boxCenterList">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff" width="200" align="center" valign="middle"><div style="width:200px; overflow:hidden;"> 
                   
                  <img src="data/brandlogo/1437436548477690017.jpg" /> 
  ...
  <div id="filter">
    <form method="GET" name="listform" action="brand.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="brand.php?id=55&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=55&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="brand.php?id=55&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="brand.php?id=55&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="brand.php?id=55&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="brand.php?category=0&display=grid&brand=55&price_min=&price_max=&filter=&filter_attr=&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			 	 </dd>
        </dl>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="文本显示"><img src="themes/68ecshopcom_360buy/images/display_mode_text.gif" alt=""></a>
      ...
      <ul class="list_pic">
                ...
                <li class="item" style="margin-left:0px;" id="li_45">
          <div class="goods-content" style="position:relative">
            ...
            <div class="goods-pic" ><a href="goods.php?id=45" target="_blank"  title="2015夏装韩版修身白色小西装女薄外套"><img data-original="images/201507/thumb_img/45_thumb_G_1437516035103.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="2015夏装韩版修身白色小西装女薄外套" class="pic_img_45"></a> </div>
              ...
              <div class="store"> 
              	...
              	<a class="compare-btn shop-compare" data-goods="45" data-type="" onclick="Compare.add(45,'2015夏装韩版修身白色小西装女薄外套','', 'images/201507/thumb_img/45_thumb_G_1437516035103.jpg', '399.0')"></a> </div>
