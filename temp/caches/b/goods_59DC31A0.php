...
<title>2015夏装韩版修身白色小西装女薄外套_连衣裙_女装馆_服装服饰_丽眼购物商城  </title>
...
<div id="tell_me_form" style="display:none;">
  ...
  <div class="tell_me_con">
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="提交" onclick="tell_me1(45)" class="tell_btn"/>
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=45#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
              ...
              <li id="choose-amount">
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> （库存<font id="shows_number">298 </font>） </div>
                </div>
              </li>
                          </ul>
  ...
  <script>
      ...
      function clickRight() {
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="45" data-type="2" onclick="Compare.add(45,'2015夏装韩版修身白色小西装女薄外套','2', 'images/201507/thumb_img/45_thumb_G_1437516035103.jpg', '478.7')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            ...
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=45#os_pinglun" >商品评价(0)</a></li>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(45,0,1)" class="cur">全部评价<span>(0)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(45,1,1)">好评<span>(0)</span></li>
