...
<title>提子葡萄_进口水果_食品生鲜_丽眼购物商城  </title>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=1">食品生鲜</a> <code>&gt;</code> <a href="category.php?id=14">进口水果</a> <code>&gt;</code> <a href="category.php?id=19">提子葡萄</a></div>
</div>
<div class="blank"></div>
  <div class="w main">
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=19&display=grid&brand=0&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  ><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left  ;color:red ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=2"'  ><a href="category.php?id=19&amp;price_min=0&amp;price_max=0&amp;filter=2" style="float:left ">入驻商店铺</a>
	  			 	 </dd>
        </dl>
...
//-->
  ...
  <div class="mc" id="cate"> 
      ...
      <ul style=" display:block;">
                ...
                <li><a href="category.php?id=19"  class="curr">提子葡萄</a></li>
