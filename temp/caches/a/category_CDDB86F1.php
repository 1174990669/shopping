...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=2">服装服饰</a> <code>&gt;</code> 达芙妮</div>
</div>
<div class="blank"></div>
  <div class="w main">
  ...
  <div id="hotsale" class="hot-sales-main">
    ...
    <div class="mc list-h">
            <dl>
        <dt><a target="_blank" href='goods.php?id=42'><img src="images/201507/thumb_img/42_thumb_G_1437515742056.jpg" width="100" height="100" alt='2015新款修身开衫短款七分袖小西装女薄网纱披肩防晒衫小外套女夏' /></a></dt>
        <dd>
          <div class="p-name"><a target="_blank" href='goods.php?id=42'>2015新款修身开衫短款七分袖小西装女薄...</a></div>
          <div class="p-price" >特价：<font class="shop_price" style="font-size:14px; color:#DD0000; font-weight:bold;">
                        259.0                        </font></div>
          <div class="btns"><a href='goods.php?id=42'>查看详情</a></div>
        </dd>
      </dl>
          </div>
  </div>
	...
	function return_url(url,dxid){
	  $.ajax({    
        ...
        <div class="box_attr_ecshop68" id="attr_list_ul">
          <h4 id="xxxccczzz"><font color="#E31939">服装服饰 - </font> 商品筛选</h4>
                    <dl style="border-bottom:1px dotted #ccc;border-top:none;">
            <dt>已选条件：</dt>
            <dd class="moredd" style="text-align:right;">&nbsp;<a href="category.php?id=2">全部撤销</dd>
            <dd >
              <ul class="selected_attr">
                                <li ><a href="category.php?id=2&amp;price_min=0&amp;price_max=0&amp;filter=0">品牌：<b >达芙妮  X</b></a></li>
                              </ul>
            </dd>
          </dl>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
              ...
              <div id="brand_abox_father" >                 <ul id="brand_abox" class="brand_abox_imgul">
                    ...
                    <a href="category.php?id=2&amp;brand=48&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','2', this);"> <img  src="data/brandlogo/1437431622196514430.jpg"> </a></li>
                   
                   
                                    <li title="享爱." name="xiangai_" rel="X" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_3" value="51">
                    <a href="category.php?id=2&amp;brand=51&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','3', this);"> <img  src="data/brandlogo/1437432512022024124.jpg"> </a></li>
                    ...
                    <a href="category.php?id=2&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','4', this);"> <img  src="data/brandlogo/1437432530915190983.jpg"> </a></li>
                   
                   
                                    <li title="缪诗" name="miaoshi" rel="M" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_5" value="54">
                    <a href="category.php?id=2&amp;brand=54&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','5', this);"> <img  src="data/brandlogo/1437432540121764652.jpg"> </a></li>
                   
                   
                                    <li title="卓诗尼" name="zhuoshini" rel="Z" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_6" value="55">
                    <a href="category.php?id=2&amp;brand=55&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','6', this);"> <img  src="data/brandlogo/1437436548477690017.jpg"> </a></li>
                   
                   
                                    <li title="七匹狼" name="qipilang" rel="Q" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_7" value="56">
                    <a href="category.php?id=2&amp;brand=56&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','7', this);"> <img  src="data/brandlogo/1437432559402862574.jpg"> </a></li>
                   
                   
                                    <li title="佐丹奴" name="zuodannu" rel="Z" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_8" value="57">
                    <a href="category.php?id=2&amp;brand=57&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','8', this);"> <img  src="data/brandlogo/1437432569401929463.jpg"> </a></li>
                   
                   
                                    <li title="达芙妮" name="dafuni" rel="D" class="bottom">
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_9" value="58">
                    <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','9', this);"> <img  src="data/brandlogo/1437436184083765295.jpg"> </a></li>
                   
                   
                                    <li title="曼妮芬（ManniForm）" name="mannifen_ManniForm_" rel="M" class="bottom">
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_10" value="60">
                    <a href="category.php?id=2&amp;brand=60&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','10', this);"> <img  src="data/brandlogo/1437432607921594733.jpg"> </a></li>
                   
                   
                                    <li title="伊芙丽" name="yifuli" rel="Y" class="bottom">
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_11" value="61">
                    <a href="category.php?id=2&amp;brand=61&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','11', this);"> <img  src="data/brandlogo/1437432618356392882.jpg"> </a></li>
                   
                   
                                    <li title="伊莱克斯" name="yilaikesi" rel="Y" class="bottom">
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_12" value="73">
                    <a href="category.php?id=2&amp;brand=73&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','12', this);"> <img  src="data/brandlogo/1437434172223731860.jpg"> </a></li>
                   
                   
                                    <li title="溢彩年华" name="yicainianhua" rel="Y" class="bottom">
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_13" value="80">
                    <a href="category.php?id=2&amp;brand=80&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','13', this);"> <img  src="data/brandlogo/1437434684850488373.jpg"> </a></li>
	      ...
	      <td><a id="button_brand"></a><a class="button_jd" onclick="duoxuan_Submit('brand',0,'1','2','58', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_brand', 'brand');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
	     ...
	     init_more('brand_abox', 'brand_more', '72');	    
            ...
            <dd>
              <ul>
                                ...
                                <li><a href="category.php?id=2&amp;brand=58&amp;price_min=90&amp;price_max=150&amp;filter=0">90&nbsp;-&nbsp;150</a></li>
                 
                 
                                <li><a href="category.php?id=2&amp;brand=58&amp;price_min=150&amp;price_max=210&amp;filter=0">150&nbsp;-&nbsp;210</a></li>
                 
                 
                                <li><a href="category.php?id=2&amp;brand=58&amp;price_min=210&amp;price_max=270&amp;filter=0">210&nbsp;-&nbsp;270</a></li>
                 
                 
                                <li><a href="category.php?id=2&amp;brand=58&amp;price_min=270&amp;price_max=330&amp;filter=0">270&nbsp;-&nbsp;330</a></li>
                 
                 
                                <li><a href="category.php?id=2&amp;brand=58&amp;price_min=330&amp;price_max=390&amp;filter=0">330&nbsp;-&nbsp;390</a></li>
                 
                 
                                <li><a href="category.php?id=2&amp;brand=58&amp;price_min=390&amp;price_max=450&amp;filter=0">390&nbsp;-&nbsp;450</a></li>
	     ...
	     <input type="text" name="price_max" id="price_max" value="0" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
                  ...
                  <a class="button_jd" href="javascript:void()" onclick="location.href='category.php?id=2&amp;brand=58&amp;filter=0&price_min='+document.getElementById('price_min').value+'&price_max='+document.getElementById('price_max').value " >确定</a> </li>
              </ul>
            </dd>
          </dl>
            ...
            <dd>
              <ul id="attr_abox_1">
                  ...
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_2" value="9">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=9" title="棕色"  onclick="return duoxuan_Onclick('1','2', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#944806;">&nbsp;</a> </span>
		   </li>
                 
                 
                                <li>  <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('1','3', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_3" value="55">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=55" title="玫红"  onclick="return duoxuan_Onclick('1','3', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#FF245E;">&nbsp;</a> </span>
		   </li>
                 
                 
                                <li>  <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('1','4', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_4" value="20">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=20" title="白色"  onclick="return duoxuan_Onclick('1','4', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#FFFFFF;">&nbsp;</a> </span>
		   </li>
                 
                 
                                <li>  <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('1','5', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_5" value="8">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=8" title="米色"  onclick="return duoxuan_Onclick('1','5', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#FFEC70;">&nbsp;</a> </span>
		   </li>
                 
                 
                                <li>  <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('1','6', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_6" value="21">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=21" title="粉色"  onclick="return duoxuan_Onclick('1','6', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#FFA1DC;">&nbsp;</a> </span>
		   </li>
                 
                 
                                <li>  <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('1','7', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_7" value="31">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=31" title="蓝色"  onclick="return duoxuan_Onclick('1','7', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#2617FF;">&nbsp;</a> </span>
		   </li>
                 
                 
                                <li>  <span class="color_ecshop68" style="position:relative;">
                  <div class="sanjiao_red" onclick="return duoxuan_Onclick('1','8', this);">&nbsp;</div>
                  <input type="checkbox" style="display:none;" name="checkbox_1[]" id="chk_1_8" value="85">
                  <a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;filter_attr=85" title="银色"  onclick="return duoxuan_Onclick('1','8', this);"  style="display:block;cursor:pointer;width:15px;height:15px;border:1px solid #fff;background:#EDEDED;">&nbsp;</a> </span>
		   </li>
	      ...
	      <td><a id="button_1"></a><a class="button_jd" onclick="duoxuan_Submit(1, '0', '1', '2','58', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_1', '1');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=2&display=grid&brand=58&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  ><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left  ;color:red ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=2"'  ><a href="category.php?id=2&amp;brand=58&amp;price_min=0&amp;price_max=0&amp;filter=2" style="float:left ">入驻商店铺</a>
	  			 	 </dd>
        </dl>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="文本显示"><img src="themes/68ecshopcom_360buy/images/display_mode_text.gif" alt=""></a>
      ...
      <ul class="list_pic">
                ...
                <li class="item" style="margin-left:0px;" id="li_42">
