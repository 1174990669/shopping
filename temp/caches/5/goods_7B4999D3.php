...
<title>苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机_iPhone_热卖手机_手机数码_丽眼购物商城  </title>
...
<body>
<input type="hidden" id="chat_goods_id" value="100" />
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机</p>
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      <tr>
        <td colspan="2" align=left style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">苹果（Apple）iPhone 6 (A...</p>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="提交" onclick="tell_me1(100)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=4">手机数码</a> <code>&gt;</code> <a href="category.php?id=144">热卖手机</a> <code>&gt;</code> <a href="category.php?id=149">iPhone</a> <code>&gt;</code> 苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机</div>
</div>
<div class="blank"></div>
  <div class="w">
            ...
            <div id="name">
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(100);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">5000.0</font> </div>
...
document.getElementById('vip2').style.display="none";
            ...
            <ul id="summary1">
                ...
                <div class="dd"> ECS000100 </div>
              </li>
               
               
                            <li class="padd1">
                <div class="dt">可使积分</div>
                <div class="dd">3000 </div>
              </li>
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=100#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
                ...
                <div class="dd catt"> 
                  ...
                  <ul class="ys_xuan" id="xuan_1">
                    <div class="catt" id="catt_1"> 
                      ...
                      <a onclick="show_attr_status(this,100, 1);get_gallery_attr(100, 114);"  href="javascript:" name="114" id="xuan_a_114"  title="[ 0.00]">                       <div style="float:left;cursor:pointer;"><img src="images/201507/thumb_img/100_thumb_P_1437523504817.jpg" width=40 height=40 title="白色" alt="白色" /></div>
                      <label style="float:left;cursor:pointer;line-height:40px;margin:0 10px 0 10px;color:#000;text-decoration:none;">白色</label>
                                            <input style="display:none" id="spec_value_114" type="radio" name="spec_1" value="114"  />
                      </a> 
                       
                      <a onclick="show_attr_status(this,100, 1);get_gallery_attr(100, 115);"  href="javascript:" name="115" id="xuan_a_115"  title="[加 100.00]">                       <div style="float:left;cursor:pointer;"><img src="images/201507/thumb_img/100_thumb_P_1437523425602.jpg" width=40 height=40 title="银色" alt="银色" /></div>
                      <label style="float:left;cursor:pointer;line-height:40px;margin:0 10px 0 10px;color:#000;text-decoration:none;">银色</label>
                                            <input style="display:none" id="spec_value_115" type="radio" name="spec_1" value="115"  />
                      </a> 
...
myString[1]="|115|";
              ...
              <li id="choose-amount">
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> （库存<font id="shows_number">2000 </font>） </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(100)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(100)" class="btn-coll ">收藏</a>   
              </div>
              ...
              <div id="choose-btns" class="buyNub-buy"> 
                ...
                <a href="javascript:collect(100)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
      ...
      <div id="preview">
        <div  class="goods_img" id="li_100"> <a href="images/201507/source_img/100_P_1437523504771.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;"> 
           
          <img  src="images/201507/goods_img/100_P_1437523504884.jpg" class="goodsimg pic_img_100" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" /> 
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/100_P_1437523504771.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/100_P_1437523504884.jpg"   title="" >
	    <img src="images/201507/thumb_img/100_thumb_P_1437523504817.jpg" alt="苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机" class="B_blue"  />
	    </a>
          </li>
                    <li>
	    <a  href="images/201507/source_img/100_P_1437523415752.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/100_P_1437523415429.jpg"   title="" >
	    <img src="images/201507/thumb_img/100_thumb_P_1437523415673.jpg" alt="苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机" class="B_blue"  />
	    </a>
          </li>
                    <li>
	    <a  href="images/201507/source_img/100_P_1437523415650.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/100_P_1437523415539.jpg"   title="" >
	    <img src="images/201507/thumb_img/100_thumb_P_1437523415326.jpg" alt="苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机" class="B_blue"  />
	    </a>
          </li>
                    <li>
	    <a  href="images/201507/source_img/100_P_1437523415946.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/100_P_1437523415086.jpg"   title="" >
	    <img src="images/201507/thumb_img/100_thumb_P_1437523415077.jpg" alt="苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=100'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="100" data-type="1" onclick="Compare.add(100,'苹果（Apple）iPhone 6 (A1586) 16GB 金色 移动联通电信4G手机','1', 'images/201507/thumb_img/100_thumb_G_1437523484060.jpg', '5000.0')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
  ...
  554fcae493e564ee0dc75bdf2ebf94caads|a:3:{s:4:"name";s:3:"ads";s:2:"id";N;s:3:"num";N;}554fcae493e564ee0dc75bdf2ebf94ca 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=100#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=100#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=100#os_pinglun" >商品评价(0)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=100#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(100)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(100,0,1)" class="cur">全部评价<span>(0)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(100,1,1)">好评<span>(0)</span></li>
    	<li id="mct_2" onClick="ShowMyComments(100,2,1)">中评<span>(0)</span></li>
