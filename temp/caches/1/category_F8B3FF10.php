...
<title>茵曼（INMAN）_母婴用品_丽眼购物商城  </title>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=8">母婴用品</a> <code>&gt;</code> 茵曼（INMAN）</div>
</div>
<div class="blank"></div>
  <div class="w main">
	  ...
	  $.ajax({    
        ...
        <div class="box_attr_ecshop68" id="attr_list_ul">
          <h4 id="xxxccczzz"><font color="#E31939">母婴用品 - </font> 商品筛选</h4>
            ...
            <dd >
              <ul class="selected_attr">
                                <li ><a href="category.php?id=8&amp;price_min=0&amp;price_max=0&amp;filter=0">品牌：<b >茵曼（INMAN）  X</b></a></li>
                              </ul>
            </dd>
          </dl>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
	      ...
	      <td><a id="button_brand"></a><a class="button_jd" onclick="duoxuan_Submit('brand',0,'','8','53', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_brand', 'brand');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
	     ...
	     init_more('brand_abox', 'brand_more', '72');	    
            ...
            <dd>
              <ul>
                                ...
                                <li><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=80&amp;filter=0">0&nbsp;-&nbsp;80</a></li>
                 
                 
                                <li><a href="category.php?id=8&amp;brand=53&amp;price_min=80&amp;price_max=160&amp;filter=0">80&nbsp;-&nbsp;160</a></li>
                 
                 
                                <li><a href="category.php?id=8&amp;brand=53&amp;price_min=160&amp;price_max=240&amp;filter=0">160&nbsp;-&nbsp;240</a></li>
                 
                 
                                <li><a href="category.php?id=8&amp;brand=53&amp;price_min=240&amp;price_max=320&amp;filter=0">240&nbsp;-&nbsp;320</a></li>
                 
                 
                                <li><a href="category.php?id=8&amp;brand=53&amp;price_min=320&amp;price_max=400&amp;filter=0">320&nbsp;-&nbsp;400</a></li>
	     ...
	     <input type="text" name="price_max" id="price_max" value="0" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
                  ...
                  <a class="button_jd" href="javascript:void()" onclick="location.href='category.php?id=8&amp;brand=53&amp;filter=0&price_min='+document.getElementById('price_min').value+'&price_max='+document.getElementById('price_max').value " >确定</a> </li>
              </ul>
            </dd>
          </dl>
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=8&display=grid&brand=53&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  ><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left  ;color:red ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=2"'  ><a href="category.php?id=8&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=2" style="float:left ">入驻商店铺</a>
	  			 	 </dd>
        </dl>
