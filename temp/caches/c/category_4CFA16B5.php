...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=8">母婴用品</a> <code>&gt;</code> <a href="category.php?id=221">孕婴奶粉</a></div>
</div>
<div class="blank"></div>
  <div class="w main">
	...
	function return_url(url,dxid){
	  $.ajax({    
        ...
        <div class="box_attr_ecshop68" id="attr_list_ul">
          <h4 id="xxxccczzz"><font color="#E31939">孕婴奶粉 - </font> 商品筛选</h4>
	     ...
	     onblur="if (this.value=='') {this.value='可搜索拼音、汉字查找品牌'}" onkeyup="getBrand_By_Name(this.value);">
              ...
              <div id="brand_abox_father" >                 <ul id="brand_abox" class="brand_abox_imgul">
                    ...
                    <a href="category.php?id=221&amp;brand=1&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','2', this);"> <img  src="data/brandlogo/1437428736611050860.jpg"> </a></li>
                   
                   
                                    <li title="蒙牛" name="mengniu" rel="M" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_3" value="40">
                    <a href="category.php?id=221&amp;brand=40&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','3', this);"> <img  src="data/brandlogo/1437431322523724265.jpg"> </a></li>
                   
                   
                                    <li title="伊利" name="yili" rel="Y" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_4" value="41">
                    <a href="category.php?id=221&amp;brand=41&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','4', this);"> <img  src="data/brandlogo/1437431337248235690.jpg"> </a></li>
                   
                   
                                    <li title="茵曼（INMAN）" name="yinman_INMAN_" rel="Y" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_5" value="53">
                    <a href="category.php?id=221&amp;brand=53&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','5', this);"> <img  src="data/brandlogo/1437432530915190983.jpg"> </a></li>
                   
                   
                                    <li title="合生元" name="heshengyuan" rel="H" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_6" value="99">
                    <a href="category.php?id=221&amp;brand=99&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','6', this);"> <img  src="data/brandlogo/1437438487779734440.jpg"> </a></li>
                   
                   
                                    <li title="美赞臣" name="meizanchen" rel="M" >
                    <input type="checkbox" style="display:none;" name="checkbox_brand[]" id="chk_brand_7" value="100">
                    <a href="category.php?id=221&amp;brand=100&amp;price_min=0&amp;price_max=0&amp;filter=0" onclick="return duoxuan_Onclick('brand','7', this);"> <img  src="data/brandlogo/1437438523104074504.jpg"> </a></li>
	      ...
	      <td><a id="button_brand"></a><a class="button_jd" onclick="duoxuan_Submit('brand',0,'','221','0', '0', '0', '0','');" >确定</a><a href="javascript:void(0);" onclick="hiddenDuoXuan('attr_group_dl_brand', 'brand');" class="button_jd" style="margin-left:10px;white-space:nowrap;">取消</a></td>
	     ...
	     init_more('brand_abox', 'brand_more', '72');	    
            ...
            <dd>
              <ul>
                                ...
                                <li><a href="category.php?id=221&amp;price_min=150&amp;price_max=200&amp;filter=0">150&nbsp;-&nbsp;200</a></li>
                 
                 
                                <li><a href="category.php?id=221&amp;price_min=200&amp;price_max=250&amp;filter=0">200&nbsp;-&nbsp;250</a></li>
                 
                 
                                <li><a href="category.php?id=221&amp;price_min=250&amp;price_max=300&amp;filter=0">250&nbsp;-&nbsp;300</a></li>
                 
                 
                                <li><a href="category.php?id=221&amp;price_min=350&amp;price_max=400&amp;filter=0">350&nbsp;-&nbsp;400</a></li>
	     ...
	     <input type="text" name="price_max" id="price_max" value="0" class="price_68ecshop" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" autocomplete="off">
                  ...
                  <a class="button_jd" href="javascript:void()" onclick="location.href='category.php?id=221&amp;filter=0&price_min='+document.getElementById('price_min').value+'&price_max='+document.getElementById('price_max').value " >确定</a> </li>
              </ul>
            </dd>
          </dl>
  ...
  <div id="filter">
    <form method="GET" name="listform" action="category.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          <dt>排序：</dt>
          <dd  class=><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=goods_id&amp;order=DESC">上架</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=salenum&amp;order=DESC">销量</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=shop_price&amp;order=DESC">价格</a><b class="icon-order-DESCending"></b></dd>
          <dd  class=curr><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
      ...
      <div class='fore1 fore3'>
        <dl class='order goods_number'>
          <dt></dt>
          <dd class=><a href="category.php?category=221&display=grid&brand=0&price_min=0&price_max=0&filter=0&filter_attr=0&page=1&sort=goods_number&order=DESC#goods_list" rel='nofollow'>仅显示有货</a></dd>
     	  <dd class="leixing">
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0"'  checked  ><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=0" style="float:left  ;color:red ">全部</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=1"'  ><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=1" style="float:left ">网站自营</a>
	  			  		<input type='radio' style="display:none" name='fff' onclick='top.location.href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=2"'  ><a href="category.php?id=221&amp;price_min=0&amp;price_max=0&amp;filter=2" style="float:left ">入驻商店铺</a>
	  			 	 </dd>
        </dl>
  ...
  <a href="javascript:;" onClick="javascript:display_mode('text')" title="文本显示"><img src="themes/68ecshopcom_360buy/images/display_mode_text.gif" alt=""></a>
      ...
      <input type="hidden" name="category" value="221" />
      ...
      <ul class="list_pic">
                ...
                <li class="item" style="margin-left:0px;" id="li_148">
          ...
          <div class="goods-content" style="position:relative">
            ...
            <div class="goods-pic" ><a href="goods.php?id=209" target="_blank"  title="雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克"><img data-original="images/201507/thumb_img/209_thumb_G_1437583601151.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" title="雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克" class="pic_img_209"></a> </div>
              ...
              <div class="add-cart"> <a href="javascript:addToCart(209);"><i class="icon-shopping-cart"></i>加入购物车</a> </div>
                ...
                <li class="item" style="margin-left:0px;" id="li_210">
          <div class="goods-content" style="position:relative">
...
{ 
        ...
        <div class="mc">
          <div class="clock" id="clock537">
            <ul>
                                          <li class="fore1" >
                <div class="p-img"><a target="_blank" title="飞鹤(FIRMUS)超级飞帆臻爱倍护幼儿配方奶粉" href="goods.php?id=212"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/212_thumb_G_1437584420342.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="飞鹤(FIRMUS)超级飞帆臻爱倍护幼儿配方奶粉" href="goods.php?id=212">飞鹤(FIRMUS)超级飞帆臻爱倍护幼儿配方奶粉</a></div>
                <div class="p-price"><strong>226.0</strong><del>271.2</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore2" >
                <div class="p-img"><a target="_blank" title="伊利 金领冠珍护幼儿配方奶粉 3段(1-3岁幼儿适用)" href="goods.php?id=211"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/211_thumb_G_1437584133612.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="伊利 金领冠珍护幼儿配方奶粉 3段(1-3岁幼儿适用)" href="goods.php?id=211">伊利 金领冠珍护幼儿配方奶粉 3段(1-3岁幼儿适用)</a></div>
                <div class="p-price"><strong>358.0</strong><del>429.5</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore3" >
                <div class="p-img"><a target="_blank" title="雅培(Abbott) 亲体 金装喜康力幼儿配方奶粉 3段（1-3岁幼儿适用）" href="goods.php?id=208"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/208_thumb_G_1437583379285.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="雅培(Abbott) 亲体 金装喜康力幼儿配方奶粉 3段（1-3岁幼儿适用）" href="goods.php?id=208">雅培(Abbott) 亲体 金装喜康力幼儿配方奶粉 3段（1-3岁幼儿适用）</a></div>
                <div class="p-price"><strong>151.0</strong><del>181.2</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore4" >
                <div class="p-img"><a target="_blank" title="惠氏(Wyeth)S-26金装爱儿乐婴儿配方奶粉 1段 900克" href="goods.php?id=210"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/210_thumb_G_1437583822170.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="惠氏(Wyeth)S-26金装爱儿乐婴儿配方奶粉 1段 900克" href="goods.php?id=210">惠氏(Wyeth)S-26金装爱儿乐婴儿配方奶粉 1段 900克</a></div>
                <div class="p-price"><strong>203.0</strong><del>243.6</del></div>
              </li>
                            <div class="blank5"></div>
               
                                                        <li class="fore5" >
                <div class="p-img"><a target="_blank" title="雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克" href="goods.php?id=209"><img width="100" height="100" alt="" data-original="images/201507/thumb_img/209_thumb_G_1437583601151.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" /></a> 
                   
                </div>
                <div class="rate"><a target="_blank" title="雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克" href="goods.php?id=209">雀巢(Nestle)超级能恩幼儿配方奶粉 3段 800克</a></div>
                <div class="p-price"><strong>278.0</strong><del>333.5</del></div>
              </li>
                            <div class="blank5"></div>
