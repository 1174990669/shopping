...
<title>可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套_厨具_家纺家居_丽眼购物商城  </title>
...
<body>
<input type="hidden" id="chat_goods_id" value="231" />
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套</p>
    ...
    <tr> 
      ...
      <input type="hidden" value="231" name="goods_id" id="goods_id">
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      <tr>
        <td colspan="2" align=left style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐...</p>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="提交" onclick="tell_me1(231)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=6">家纺家居</a> <code>&gt;</code> <a href="category.php?id=308">厨具</a> <code>&gt;</code> 可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套</div>
</div>
<div class="blank"></div>
  <div class="w">
      ...
      <form action="javascript:addToCart(231)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
        <div class="clearfix" style="width:591px; min-height:510px;">
          <div class="goods_info">
            <div id="name">
              <h1>可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套</h1>
            </div>
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(231);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">118.8</font> </div>
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=231#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
...
var myString=new Array();
            ...
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(231)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(231)" class="btn-coll ">收藏</a>   
              </div>
     
              <div id="choose-btns" class="buyNub-buy"> 
                 
                <a href="javascript:addToCart(231,0,1)" name="bi_addToCart" class="u-buy1">立即购买</a> <a href="javascript:addToCart(231)" name="bi_addToCart" class="u-buy2">加入购物车</a> 
                 
                <a href="javascript:collect(231)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
                <div id="phone_tan" style="display:none"> <span class="arr"></span>
                  <div class="m-qrcode-wrap"> <img src="erweima_png.php?id=231" width="100" height="100" /> </div>
                </div>
                </a>  
              </div>
              <script type="text/javascript">
      ...
      <div id="preview">
        <div  class="goods_img" id="li_231"> <a href="images/201507/source_img/231_P_1437587773861.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;"> 
           
          <img  src="images/201507/goods_img/231_P_1437587773973.jpg" class="goodsimg pic_img_231" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" /> 
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/231_P_1437587773861.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/231_P_1437587773973.jpg"   title="" >
	    <img src="images/201507/thumb_img/231_thumb_P_1437587773385.jpg" alt="可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=231'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="231" data-type="0" onclick="Compare.add(231,'可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套','0', 'images/201507/thumb_img/231_thumb_G_1437587773545.jpg', '118.8')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
  ...
  554fcae493e564ee0dc75bdf2ebf94caads|a:3:{s:4:"name";s:3:"ads";s:2:"id";N;s:3:"num";N;}554fcae493e564ee0dc75bdf2ebf94ca 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=231#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=231#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=231#os_pinglun" >商品评价(0)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=231#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(231)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
        ...
        <div id="main_widget_1">
          <div class="mc" id="os_canshu">
            <ul class="detail-list">
              <li>商品名称：可爱卡通餐盘水果盘点心盘 盘子儿童托盘餐具6件套</li>
              <li>商品编号：ECS000231</li>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(231,0,1)" class="cur">全部评价<span>(0)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(231,1,1)">好评<span>(0)</span></li>
    	<li id="mct_2" onClick="ShowMyComments(231,2,1)">中评<span>(0)</span></li>
    	<li id="mct_3" onClick="ShowMyComments(231,3,1)">差评<span>(0)</span></li>
    	<li id="mct_4" onClick="ShowMyComments(231,4,1)">用户晒单<span>(0)</span></li>
    </ul>
</div>
<div class="blank"></div>
