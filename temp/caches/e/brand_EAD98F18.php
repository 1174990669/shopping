    ...
    <form method="GET" name="listform" action="brand.php">
      <div class='fore1' style="border:none;">
        <dl class='order'>
          ...
          <dd  class=curr><a href="brand.php?id=25&amp;page=1&amp;sort=last_update&amp;order=DESC">更新</a><b class="icon-order-ASCending"></b></dd>
          <dd class=><a href="brand.php?id=25&amp;page=1&amp;sort=click_count&amp;order=DESC" rel='nofollow'>人气</a><b class="icon-order-DESCending"></b></dd>
	</dl>
