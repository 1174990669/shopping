...
<title>小米（MI）小米Note 移动联通双4G 特别版(16G ROM)_小米特供_热卖手机_手机数码_丽眼购物商城  </title>
...
<div id="tell_me_form" style="display:none;">
  ...
  <div class="tell_me_con">
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="提交" onclick="tell_me1(143)" class="tell_btn"/>
          ...
          <div class="goods_info">
            <div id="name">
              ...
              <div class="show_price" style="z-index:101"> 
                                <div class="market_prices_t"> <span class="price">市场价</span><font class="market_price">2500.0</font> </div>
                  ...
                  <div class="hover" style="display:none;" id="vip2" onmouseover="hidevip1()" onmouseout="showvip1()"> <span class="rmbPrice">会员等级价格<i></i></span> 
                    ...
                    <span class="rmbPrice"> 铜牌会员：1993.1</span> 
                     
                    </br>
                    <span class="rmbPrice"> 金牌会员：1888.2</span> 
                     
                    </br>
                    <span class="rmbPrice"> 钻石会员：1783.3</span> 
...
document.getElementById('vip2').style.display="none";
            ...
            <div id="summary-qita" class="clearfix">
              <ul class="qita">
                <li>
                  <p>累积评价<span><a href="/goods.php?id=143#os_pinglun">0人评价</a></span></p>
                </li>
                <li>
              ...
              <li id="choose-amount">
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> （库存<font id="shows_number">2800 </font>） </div>
                </div>
              </li>
                          </ul>
  ...
  <script>
      ...
      function clickRight() {
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="143" data-type="1" onclick="Compare.add(143,'小米（MI）小米Note 移动联通双4G 特别版(16G ROM)','1', 'images/201507/thumb_img/143_thumb_G_1437529603664.jpg', '2500.0')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            ...
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=143#os_pinglun" >商品评价(0)</a></li>
...
<div class="my_comment_tab">
	<ul class="clearfix">
    	<li id="mct_0" onClick="ShowMyComments(143,0,1)" class="cur">全部评价<span>(0)</span></li>
    	<li id="mct_1" onClick="ShowMyComments(143,1,1)">好评<span>(0)</span></li>
    	<li id="mct_2" onClick="ShowMyComments(143,2,1)">中评<span>(0)</span></li>
    	<li id="mct_3" onClick="ShowMyComments(143,3,1)">差评<span>(0)</span></li>
    	<li id="mct_4" onClick="ShowMyComments(143,4,1)">用户晒单<span>(0)</span></li>
    </ul>
</div>
<div class="blank"></div>
