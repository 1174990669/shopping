...
<title>小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋_母婴用品_丽眼购物商城  </title>
...
<body>
<input type="hidden" id="chat_goods_id" value="41" />
...
<table cellpadding=0 cellspacing=0 width="90%" border=0>  
    <tr> 
      ...
      <p style="font-size:15px;font-weight:bold;color:#F52648;padding-bottom:5px;">小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋</p>
    ...
    <table cellpadding=0 cellspacing=0 width="100%" border=0>
      <tr>
        <td colspan="2" align=left style="padding:15px 0 15px 0;"><div style="background:#FFFDEE ;padding:10px 10px;border:1px dotted #ff3300;height:40px;line-height:150%; font-weight:normal">
            <p style="font-size:15px;color:#F52648;padding-bottom:5px;">小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋</p>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="提交" onclick="tell_me1(41)" class="tell_btn"/>
...
$('.search-type li').click(function() {
  ...
  <div class="blank"></div>
  <div class="w">
  <div class="breadcrumb"><i></i><a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=8">母婴用品</a> <code>&gt;</code> 小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋</div>
</div>
<div class="blank"></div>
  <div class="w">
            ...
            <div id="name">
              ...
              <div class="mar_l">
                <p> 
                  ...
                  <span class="depreciate"><a href="javascript:showDiv(41);" style="color:#ffffff;text-decoration:none;">降价通知</a></span> </p>
              </div>
...
var myString=new Array();
              ...
              <li id="choose-amount">
                ...
                <div class="dd">
                  <div class="wrap-input"> 
                    ...
                    <a class="btn-add" href="javascript:;" onclick="goods_add();changePrice();">增加数量</a> （库存<font id="shows_number">1867 </font>） </div>
                </div>
              </li>
                          </ul>
            <div class="buyNub-buy-wrap">
             ...
             <div id="choose-btns1" class="buyNub-buy" style="display:none"> 
                ...
                <a onclick="tell_me(41)" class="tell_me"/><i></i>到货通知</a>
                
                <a href="javascript:collect(41)" class="btn-coll ">收藏</a>   
              </div>
              ...
              <div id="choose-btns" class="buyNub-buy"> 
                ...
                <a href="javascript:collect(41)" class="btn-coll ">收藏</a> <a id="phone" class="btn-phone" style="position:relative;cursor:pointer">去手机购买
      ...
      <div id="preview">
        <div  class="goods_img" id="li_41"> <a href="images/201507/source_img/41_P_1437515470303.jpg" class="MagicZoom" id="zoom" rel="zoom-position: right;"> 
           
          <img  src="images/201507/goods_img/41_P_1437515470112.jpg" class="goodsimg pic_img_41" id="goods_bimg" width="378" height="378" style="border:#DDDDDD 1px solid; width:378px; height:378px;" /> 
...
<div class="clearfix" class="goods_picture"> <span class="scrleft" onmouseover="moveLeft()" onmousedown="clickLeft()" onmouseup="moveLeft()" onmouseout="scrollStop()"></span>
  <div class="gallery">
    <div id="demo">
      <div id="demo1" style="float:left;">
        <ul id="goods_gallery">
                    <li>
	    <a  href="images/201507/source_img/41_P_1437515470303.jpg" rel="zoom-id: zoom;" rev="images/201507/goods_img/41_P_1437515470112.jpg"   title="" >
	    <img src="images/201507/thumb_img/41_thumb_P_1437515470317.jpg" alt="小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋" class="B_blue"  />
	    </a>
          </li>
                  </ul>
      </div>
  ...
  <script>
      ...
      function clickRight() {
        ...
        <div id="short-share">
          <div id="view-bigimg" class="fl" style="margin-right:20px;"><b></b><a href="javascript:;" onclick="window.open('gallery.php?id=41'); return false;" target="_blank">查看大图</a></div>
		...
		document.getElementById("bdshell_js").src = "http://bdimg.share.baidu.com/static/js/shell_v2.js?cdnversion=" + Math.ceil(new Date()/3600000);
          ...
          <div class="fl com-pare"> <a class="compare-btn" data-goods="41" data-type="0" onclick="Compare.add(41,'小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋','0', 'images/201507/thumb_img/41_thumb_G_1437515470354.jpg', '118.8')"></a> </div>
          <div class="clb"></div>
        </div>
      </div>
      <div id="supp_info"> 
  ...
  554fcae493e564ee0dc75bdf2ebf94caads|a:3:{s:4:"name";s:3:"ads";s:2:"id";N;s:3:"num";N;}554fcae493e564ee0dc75bdf2ebf94ca 
    ...
    <div class="right goods_right">       <div id="wrapper" class="m m1">
        <div class="mt" id="main-nav-holder">
          <ul class="tab" id="nav">
            <li class="boldtit_list h_list" onclick="change_widget(1, this);"><a href="/goods.php?id=41#os_canshu">规格参数</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=41#os_jieshao" >商品介绍</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=41#os_pinglun" >商品评价(0)</a></li>
            <li class="boldtit_list" onclick="change_widget(1, this);"><a href="/goods.php?id=41#os_shouhou" >售后保障</a></li>
          </ul>
          <div style="width:170px;float:right; position:relative;left:0;top:0"> <a href="javascript:addToCart(41)" name="bi_addToCart"  class="right_add" >加入购物车</a>
            <div class="ce_right">
              <ul class="abs_ul">
        ...
        <div id="main_widget_1">
          <div class="mc" id="os_canshu">
            <ul class="detail-list">
              <li>商品名称：小金蛋女宝宝皮鞋夏真皮女童秋鞋公主鞋</li>
              <li>商品编号：ECS000041</li>
