<?php exit;?>a:3:{s:8:"template";a:12:{i:0;s:66:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/pre_sale_list.dwt";i:1;s:72:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/page_header.lbi";i:2;s:72:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/user_header.lbi";i:3;s:78:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/user_header_right.lbi";i:4;s:71:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/header_tan.lbi";i:5;s:69:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/head_nav.lbi";i:6;s:66:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/pages.lbi";i:7;s:65:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/help.lbi";i:8;s:72:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/page_footer.lbi";i:9;s:69:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/site_bar.lbi";i:10;s:77:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/customer_service.lbi";i:11;s:70:"/www/wwwroot/dianshang/themes/68ecshopcom_360buy/library/vote_list.lbi";}s:7:"expires";i:1524172541;s:8:"maketime";i:1524168941;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
			...
			<div class="w">
				<div class="l">
					<div class="pro">
							...
							<div class="pic" id="li_32">
								<a href="pre_sale.php?id=32" target="_blank"> <img title="Lindt瑞士莲黑巧克力特醇排装德国进口 70%可可黑巧克力10块组合 特惠分享装" alt="Lindt瑞士莲黑巧克力特醇排装德国进口 70%可可黑巧克力10块组合 特惠分享装" width=220 height=220 data-original="images/201507/thumb_img/32_thumb_G_1437506920994.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_32"></a> 							</div>
							<div class="shijian" id="shijian1_0">
								<i></i> <span id="ps_label_32" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_32" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				...
					   	    				$("#ps_cd_32").html("");
					   	    				$("#ps_label_32").html("预售中");
					   	    				$("#ps_label_32").attr("over", true);
					   	    				status = 1;
							...
							<div class="title">
								<a title="Lindt瑞士莲黑巧克力特醇排装德国进口 70%可可黑巧克力10块组合 特惠分享装" href="pre_sale.php?id=32" target="_blank">Lindt瑞士莲黑巧克力特醇排装德国进口 70%可可黑巧克力10块组合 特惠分享装</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>40.00</span><span class="yp">299.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_32" href="javascript:collect(32); re_collect(32)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=32" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_0").mouseenter(function(){
			            	  	var isover = $("#ps_label_32").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_32").show();
			            ...
			            $(function(){
			              ...
			              $("#shijian_1").mouseleave(function(){
							...
							<div class="pic" id="li_74">
								<a href="pre_sale.php?id=30" target="_blank"> <img title="德运Devondale 脱脂高钙奶粉1kg" alt="德运Devondale 脱脂高钙奶粉1kg" width=220 height=220 data-original="images/201507/thumb_img/74_thumb_G_1437521987425.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_74"></a> 							</div>
							<div class="shijian" id="shijian1_2">
								<i></i> <span id="ps_label_74" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_74" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_74").html("");
					   	    				$("#ps_label_74").html("预售中");
					   	    				$("#ps_label_74").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2015, 07-1, 27, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
							...
							<div class="title">
								<a title="德运Devondale 脱脂高钙奶粉1kg" href="pre_sale.php?id=30" target="_blank">德运Devondale 脱脂高钙奶粉1kg</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>49.00</span><span class="yp">79.90</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_74" href="javascript:collect(74); re_collect(74)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=30" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_2").mouseenter(function(){
			            	  	var isover = $("#ps_label_74").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_74").show();
			              ...
			              $("#shijian_2").mouseleave(function(){
							...
							<div class="pic" id="li_72">
								<a href="pre_sale.php?id=29" target="_blank"> <img title="波兰 进口牛奶 日昇（MLEKOVITA）全脂牛奶1L*12盒" alt="波兰 进口牛奶 日昇（MLEKOVITA）全脂牛奶1L*12盒" width=220 height=220 data-original="images/201507/thumb_img/72_thumb_G_1437521848992.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_72"></a> 							</div>
							<div class="shijian" id="shijian1_3">
								<i></i> <span id="ps_label_72" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_72" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_72").html("");
					   	    				$("#ps_label_72").html("预售中");
					   	    				$("#ps_label_72").attr("over", true);
					   	    				status = 1;
							...
							<div class="title">
								<a title="波兰 进口牛奶 日昇（MLEKOVITA）全脂牛奶1L*12盒" href="pre_sale.php?id=29" target="_blank">波兰 进口牛奶 日昇（MLEKOVITA）全脂牛奶1L*12盒</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>50.00</span><span class="yp">109.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_72" href="javascript:collect(72); re_collect(72)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=29" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_3").mouseenter(function(){
			            	  	var isover = $("#ps_label_72").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_72").show();
			              ...
			              $("#shijian_3").mouseleave(function(){
			              		$("#shijian1_3").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_72").hide();
																								...
																								<div class="product" id="shijian_4" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							...
							<div class="shijian" id="shijian1_4">
						...
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_4").mouseenter(function(){
			            	  	var isover = $("#ps_label_67").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_67").show();
			        				$("#shijian1_4").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_4").mouseleave(function(){
			              		$("#shijian1_4").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_67").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_5" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							...
							<div class="shijian" id="shijian1_5">
						...
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_5").mouseenter(function(){
			            	  	var isover = $("#ps_label_62").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_62").show();
			        				$("#shijian1_5").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_5").mouseleave(function(){
			              		$("#shijian1_5").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_62").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_6" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							...
							<div class="shijian" id="shijian1_6">
						...
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_6").mouseenter(function(){
			            	  	var isover = $("#ps_label_55").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_55").show();
			        				$("#shijian1_6").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_6").mouseleave(function(){
			              		$("#shijian1_6").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_55").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_7" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" style="margin-right: 0px;">
							<div class="pic" id="li_78">
								<a href="pre_sale.php?id=23" target="_blank"> <img title="100%桑蚕丝两件套夏季短袖真丝睡衣女套装" alt="100%桑蚕丝两件套夏季短袖真丝睡衣女套装" width=220 height=220 data-original="images/201507/thumb_img/78_thumb_G_1437522187316.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_78"></a> 							</div>
							<div class="shijian" id="shijian1_7">
								<i></i> <span id="ps_label_78" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_78" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
							...
							<div class="title">
								<a title="100%桑蚕丝两件套夏季短袖真丝睡衣女套装" href="pre_sale.php?id=23" target="_blank">100%桑蚕丝两件套夏季短袖真丝睡衣女套装</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>88.00</span><span class="yp">199.00</span>
							...
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_78" href="javascript:collect(78); re_collect(78)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=23" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_7").mouseenter(function(){
			            	  	var isover = $("#ps_label_78").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_78").show();
			        				$("#shijian1_7").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_7").mouseleave(function(){
			              		$("#shijian1_7").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_78").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_8" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_31">
								<a href="pre_sale.php?id=19" target="_blank"> <img title="台湾进口 百年老店糖之坊夏威夷果牛轧糖奶糖（蔓越莓味）120克" alt="台湾进口 百年老店糖之坊夏威夷果牛轧糖奶糖（蔓越莓味）120克" width=220 height=220 data-original="images/201507/thumb_img/31_thumb_G_1437506821290.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_31"></a> 							</div>
							<div class="shijian" id="shijian1_8">
								<i></i> <span id="ps_label_31" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_31" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_31").html("");
					   	    				$("#ps_label_31").html("预售中");
					   	    				$("#ps_label_31").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2016, 07-1, 27, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
							...
							<div class="title">
								<a title="台湾进口 百年老店糖之坊夏威夷果牛轧糖奶糖（蔓越莓味）120克" href="pre_sale.php?id=19" target="_blank">台湾进口 百年老店糖之坊夏威夷果牛轧糖奶糖（蔓越莓味）120克</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>50.00</span><span class="yp">35.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_31" href="javascript:collect(31); re_collect(31)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=19" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_8").mouseenter(function(){
			            	  	var isover = $("#ps_label_31").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_31").show();
			        				$("#shijian1_8").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_8").mouseleave(function(){
			              		$("#shijian1_8").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_31").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_9" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_54">
								<a href="pre_sale.php?id=18" target="_blank"> <img title="墨西哥牛油果9个 牛油果 鳄梨 牛油果水果 21-24号发" alt="墨西哥牛油果9个 牛油果 鳄梨 牛油果水果 21-24号发" width=220 height=220 data-original="images/201507/thumb_img/54_thumb_G_1437520360548.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_54"></a> 							</div>
							<div class="shijian" id="shijian1_9">
								<i></i> <span id="ps_label_54" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_54" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	   				 ...
				   	   				 function(n){ return n.toString()
				            					   	           	...
				            					   	           	var endDate = new Date(2016, 07-1, 19, 00, 00, 00);
				            					   	           	//if(54 == 62){
				   	           	//	endDate = new Date(2015, 6, 29, 12, 09);
				   	           	//}
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_54").html("");
					   	    				$("#ps_label_54").html("预售中");
					   	    				$("#ps_label_54").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2016, 07-1, 19, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
				   	    			}else{
				   	    				//预售中->活动已结束
							...
							<div class="title">
								<a title="墨西哥牛油果9个 牛油果 鳄梨 牛油果水果 21-24号发" href="pre_sale.php?id=18" target="_blank">墨西哥牛油果9个 牛油果 鳄梨 牛油果水果 21-24号发</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>66.00</span><span class="yp">80.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_54" href="javascript:collect(54); re_collect(54)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=18" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_9").mouseenter(function(){
			            	  	var isover = $("#ps_label_54").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_54").show();
			        				$("#shijian1_9").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_9").mouseleave(function(){
			              		$("#shijian1_9").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_54").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_10" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" >
							<div class="pic" id="li_52">
								<a href="pre_sale.php?id=17" target="_blank"> <img title="昆仑玉红枣 和田香枣二级500g 新疆特产 免洗零食 和田大枣子" alt="昆仑玉红枣 和田香枣二级500g 新疆特产 免洗零食 和田大枣子" width=220 height=220 data-original="images/201507/thumb_img/52_thumb_G_1437520436446.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_52"></a> 							</div>
							<div class="shijian" id="shijian1_10">
								<i></i> <span id="ps_label_52" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_52" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_52").html("");
					   	    				$("#ps_label_52").html("预售中");
					   	    				$("#ps_label_52").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2016, 07-1, 27, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
							...
							<div class="title">
								<a title="昆仑玉红枣 和田香枣二级500g 新疆特产 免洗零食 和田大枣子" href="pre_sale.php?id=17" target="_blank">昆仑玉红枣 和田香枣二级500g 新疆特产 免洗零食 和田大枣子</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>77.00</span><span class="yp">0.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_52" href="javascript:collect(52); re_collect(52)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=17" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_10").mouseenter(function(){
			            	  	var isover = $("#ps_label_52").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_52").show();
			        				$("#shijian1_10").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_10").mouseleave(function(){
			              		$("#shijian1_10").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_52").hide();
			              		});
			              });
			            });
			            </script>
																								<div class="product" id="shijian_11" onmouseover="this.className='product hover1'" onmouseout="this.className='product'" style="margin-right: 0px;">
							<div class="pic" id="li_97">
								<a href="pre_sale.php?id=16" target="_blank"> <img title="除湿机家用抽湿机20B 地下室别墅吸湿器除湿器" alt="除湿机家用抽湿机20B 地下室别墅吸湿器除湿器" width=220 height=220 data-original="images/201507/thumb_img/97_thumb_G_1437523257758.jpg" src="themes/68ecshopcom_360buy/images/loading.gif" class="pic_img_97"></a> 							</div>
							<div class="shijian" id="shijian1_11">
								<i></i> <span id="ps_label_97" style="text-align: center;" over="false">结束未处理</span> <span id="ps_cd_97" style="display: none;"></span>
							</div>
							<script type="text/javascript">
				            $().ready(function(){
				            	countdown.setLabels(
				   	           	...
				   	           	function countdown_callback(ts){
				   	    			...
				   	    			if(status == 0){
				   	    				...
				   	    				if(ts == "End"){
					   	    				window.clearInterval(timerId);
					   	    				$("#ps_cd_97").html("");
					   	    				$("#ps_label_97").html("预售中");
					   	    				$("#ps_label_97").attr("over", true);
					   	    				status = 1;
					   	    				endDate = new Date(2016, 07-1, 27, 00, 00, 00);
					   	    				timerId = countdown(countdown_callback, endDate, countdown.DAYS | countdown.HOURS | countdown.MINUTES | countdown.SECONDS);
					   	    			}
							...
							<div class="title">
								<a title="除湿机家用抽湿机20B 地下室别墅吸湿器除湿器" href="pre_sale.php?id=16" target="_blank">除湿机家用抽湿机20B 地下室别墅吸湿器除湿器</a>
							</div>
							<div class="price3">
								<div class="y-price">
									<span>999.00</span><span class="yp">259.00</span>
								</div>
								<span class="valid_order">0人已购买</span>
							</div>
							<div class="buy3">
								<div class="n-tg">
									<a id="collect_97" href="javascript:collect(97); re_collect(97)">收藏</a>
								</div>
								<div class="n-tg">
									<a title="立即抢购" href="pre_sale.php?id=16" target="_blank">立即抢购</a>
								</div>
							</div>
						</div>
						<script type="text/javascript">
			            $(function(){
			              $("#shijian_11").mouseenter(function(){
			            	  	var isover = $("#ps_label_97").attr("over");
			                	if(isover == "false")
			                	{
			                		$("#ps_cd_97").show();
			        				$("#shijian1_11").animate({width:'260px'}, "fast");
			                	}
			              });
			              $("#shijian_11").mouseleave(function(){
			              		$("#shijian1_11").animate({width:'100px'}, "fast", function(){
			            			$("#ps_cd_97").hide();
			              		});
			              });
			            });
