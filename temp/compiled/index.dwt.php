...
<?php $this->assign('articles',$this->_var['articles_19']); ?><?php $this->assign('articles_cat',$this->_var['articles_cat_19']); ?><?php echo $this->fetch('library/cat_articles.lbi'); ?>
  ...
  <script type="text/javascript">
	...
	<?php $_from = $this->_var['row']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'row_0_09586300_1519981264');if (count($_from)):
    foreach ($_from AS $this->_var['row_0_09586300_1519981264']):
?>
	<?php if ($this->_var['row_0_09586300_1519981264']['send_start_date'] < $this->_var['time'] && $this->_var['row_0_09586300_1519981264']['send_end_date'] > $this->_var['time']): ?>
    <div class="bonusimg_box">
		<a href="javascript:;" onclick="fun(<?php echo $this->_var['row_0_09586300_1519981264']['type_id']; ?>)" style="background:url(data/bonusimg/<?php echo $this->_var['row_0_09586300_1519981264']['bonus_code']; ?>) no-repeat center top;"></a>
	</div>
	<?php endif; ?> 
...
if ($this->_foreach['index_goods']['total'] > 0):
    foreach ($_from AS $this->_var['key'] => $this->_var['goods']):
        $this->_foreach['index_goods']['iteration']++;
?> 
          <?php if ($this->_foreach['index_goods']['iteration'] > 0 && $this->_foreach['index_goods']['iteration'] < 5): ?>
          <li>
            <dl>
