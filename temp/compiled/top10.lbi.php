...
<div id="weekRank" class="m rank" >
  ...
  <div class="mc">
    <ul class="tabcon">
      <?php $_from = $this->_var['top_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_69017000_1520332359');$this->_foreach['top_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['top_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_69017000_1520332359']):
...
?>
      ...
      <li class="fore <?php if ($this->_foreach['top_goods']['iteration'] < 4): ?>fore1<?php endif; ?>" id="top2b<?php echo $this->_foreach['top_goods']['iteration']; ?>" style="display:none; <?php if (($this->_foreach['top_goods']['iteration'] == $this->_foreach['top_goods']['total'])): ?>border-bottom:none;<?php endif; ?>"><span><?php echo $this->_foreach['top_goods']['iteration']; ?></span>
        <div class="p-img"><a target='_blank' href='<?php echo $this->_var['goods_0_69017000_1520332359']['url']; ?>'> <img src="<?php echo $this->_var['goods_0_69017000_1520332359']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_69017000_1520332359']['name']); ?>" width="50" height="50"/></a></div>
        <div class="p-name"><a target='_blank' href='<?php echo $this->_var['goods_0_69017000_1520332359']['url']; ?>'><?php echo $this->_var['goods_0_69017000_1520332359']['short_name']; ?></a></div>
        <div class="price" style=" color:#DD0000"> <?php echo $this->_var['goods_0_69017000_1520332359']['price']; ?> </div>
      </li>
      ...
      <div class="p-name"><a  href='<?php echo $this->_var['goods_0_69017000_1520332359']['url']; ?>'><?php echo $this->_var['goods_0_69017000_1520332359']['short_name']; ?><font color="#ff6600" ></font></a></div>
      </li>
