...
<div class="act-list">
    <form name="compareForm" method="post">
      <ul class="clearfix">
        <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_90513400_1520333077');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_90513400_1520333077']):
        $this->_foreach['goods']['iteration']++;
?> 
        <?php if ($this->_var['goods_0_90513400_1520333077']['goods_id']): ?>
        <li <?php if ($this->_foreach['goods']['iteration'] % 4 == 1): ?>class="first"<?php endif; ?>>
            <div class="img">
                <a href='<?php echo $this->_var['goods_0_90513400_1520333077']['url']; ?>' target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_90513400_1520333077']['goods_name']); ?>"><img  src='<?php echo $this->_var['goods_0_90513400_1520333077']['goods_thumb']; ?>' width="200" height="200" alt='<?php echo htmlspecialchars($this->_var['goods_0_90513400_1520333077']['name']); ?>' /></a>
                <p class="absBg"></p>
                <p class="absFg"><a href='<?php echo $this->_var['goods_0_90513400_1520333077']['url']; ?>' target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_90513400_1520333077']['goods_name']); ?>"><?php echo $this->_var['goods_0_90513400_1520333077']['goods_name']; ?></a></p>
            </div>
            <div class="info">
                <div class="price"><strong class="red arial"><?php echo $this->_var['goods_0_90513400_1520333077']['exchange_integral']; ?></strong><span class="red jifen">积分</span></div>
                <div class="discount"><span class="f16 yahei"><a href='<?php echo $this->_var['goods_0_90513400_1520333077']['url']; ?>' target="_blank">立即兑换</a></span></div>
            </div>
        </li>
        <?php endif; ?> 
