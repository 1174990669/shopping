          ...
          <?php else: ?>
              ...
              <div class="presell-wrap" id="summary-presell">
                <div id="presell-detail" class="m">
                  <div class="mt">
                    <strong>定金：</strong>
                    <span><?php echo $this->_var['goods']['deposit']; ?> +</span>
                    <span class="presell-balance hide" style="display:inline;">
                      <strong>尾款：</strong>
                     
                      <span id="weikuan"><?php echo $this->_var['goods']['formated_cur_price']; ?> </span>
                    </span>
...
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <div class="buyNub-buy-wrap clearfix" style="z-index:100">
              ...
              <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>, 0, 1);" class="u-buy2">立刻支付定金</a> 
              <?php elseif ($this->_var['goods']['status'] < 2): ?>
              <a href="javascript:addToCart(<?php echo $this->_var['goods']['goods_id']; ?>, 0, 1);" name="on_addToCart" class="u-buy1">立刻付款</a>  
              <?php elseif ($this->_var['goods']['status'] >= 2): ?>
...
?>
          ...
          <div class="mc" id="os_advantage">
            <div class="blank20"></div>
            <?php echo $this->fetch('library/advantage.lbi'); ?> </div>
        </div>
      </div>
      <script type="text/javascript">
